...
import android.os.Bundle; import android.util.Log; import android.view.View; import android.widget.Button; import android.widget.EditText; import android.widget.Toast; import org.json.JSONArray; import org.json.JSONException; import org.json.JSONObject; import java.util.ArrayList; import java.util.List;
public class NovoUsuarioActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPreferences = this.getSharedPreferences(getString(R.string.file_usuario),
                MODE_PRIVATE);
    ...
    public void onClick(View view) {
        ...
        if(!senha.equals(confirma)){
            Toast.makeText(this, getString(R.string.erro_confirma_senha),
